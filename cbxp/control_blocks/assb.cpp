...
nlohmann::json ASSB::get(void* __ptr32 p_control_block) {
  ...
  std::memcpy(&assb_switch_to_zaapziip_count,
              p_assb->assb_switch_to_zaapziip_count, 8);
  ...
  std::memcpy(&assb_hdlockpromotion_time_at_pdp,
              p_assb->assb_hdlockpromotion_time_at_pdp, 8);
  assb_json["assb_hdlockpromotion_time_at_pdp"] =
      assb_hdlockpromotion_time_at_pdp;

  uint64_t assb_enct_hdlockpromote_time;
  std::memcpy(&assb_enct_hdlockpromote_time,
              p_assb->assb_enct_hdlockpromote_time, 8);
  ...
  std::memcpy(&assb_varweighted_time_at_pdp,
              p_assb->assb_varweighted_time_at_pdp, 8);
