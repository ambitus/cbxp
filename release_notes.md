...
* End support for **Python 3.12** since IBM will end support for the [IBM Open Enterprise SDK for Python 3.12](https://www.ibm.com/docs/en/python-zos/3.12.0) in April 2026 ([??]())
* Add support for **Python 3.14**
* Start compiling all distributions of CBXP with the [IBM Open XL C/C++ 2.2](https://www.ibm.com/docs/en/open-xl-c-cpp-zos/2.2.0) compiler
